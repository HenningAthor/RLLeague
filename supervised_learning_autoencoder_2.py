...
if __name__ == '__main__':
    ...
    autoencoder = AE(37, 2)
    autoencoder.load(f'autoencoder/autoencoder_2')
    autoencoder.double()
    ...
    autoencoder_features_header = ['a1', 'a2']
    ...
    autoencoder_min_max_headers = ['a1', 'a2']
    ...
    for mutate_p, (min_tree_size, max_tree_size) in itertools.product(mutate_probabilities, tree_sizes):
        ...
        file_name = f"autoencoder2_{mutate_p}_{min_tree_size}_{max_tree_size}.pickle"
