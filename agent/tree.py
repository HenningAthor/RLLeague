...
class Tree(object):
    ...
    def __deepcopy__(self,
        ...
        new_tree.has_numba_jit = self.has_numba_jit
    ...
    def eval(self,
        ...
        """
        if self.has_numba_jit and arr is not None:
...
def recombine_trees(tree_1: 'Tree',
    ...
    """
    tree_1.has_numba_jit = False
    tree_2.has_numba_jit = False
